...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	superPriorityRunner := service.ProvideSuperPriorityRunner(superPriorityService, accountTestService, accountRepository, rateLimitService)
