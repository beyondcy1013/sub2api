...
func registerAccountRoutes(admin *gin.RouterGroup, h *handler.Handlers, stepUpAuth middleware.StepUpAuthMiddleware, stickySessionReassignmentEnabled bool) {
	accounts := admin.Group("/accounts")
	{
		...
		accounts.GET("/trash", h.Admin.Account.ListTrash)
		...
		accounts.PUT("/:id/balance-query", h.Admin.Account.UpdateAccountBalanceQueryConfig)
		accounts.POST("/:id/balance-query", h.Admin.Account.QueryAccountBalance)
		accounts.GET("/:id/policy-settings", h.Admin.Account.GetPolicySettings)
		accounts.PUT("/:id/policy-settings", h.Admin.Account.UpdatePolicySettings)
