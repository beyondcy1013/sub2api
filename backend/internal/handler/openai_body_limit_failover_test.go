...
func TestOpenAIBodyLimitFailoverExhausted_ReturnsRedactedJSON413(t *testing.T) {
	...
	require.Equal(t, "【sub2freeApi限制】 Request payload is too large (source: sub2freeApi)", errBody["message"])
...
func TestOpenAIBodyLimitFailoverExhausted_ReturnsRedactedResponsesSSE(t *testing.T) {
	...
	require.Contains(t, body, `"message":"【sub2freeApi限制】 Request payload is too large (source: sub2freeApi)"`)
