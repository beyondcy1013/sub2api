...
func (m *mockAccountRepoForGemini) PinAccount(ctx context.Context, id int64) error     { return nil }
func (m *mockAccountRepoForGemini) UnpinAccount(ctx context.Context, id int64) error   { return nil }
...
func (m *mockAccountRepoForGemini) ListWithFilters(ctx context.Context, params pagination.PaginationParams, platform, accountType, status, search string, groupID int64, privacyMode string, _ bool) ([]Account, *pagination.PaginationResult, error) {
	return nil, nil, nil
}
func (m *mockAccountRepoForGemini) ListAllWithFilters(ctx context.Context, platform, accountType, status, search string, groupID int64, privacyMode string, _ bool) ([]Account, error) {
	return nil, nil
}
