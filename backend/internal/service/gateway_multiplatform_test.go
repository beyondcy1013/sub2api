...
func (m *mockAccountRepoForPlatform) RecycleAccount(ctx context.Context, id int64) error {
	return nil
}
func (m *mockAccountRepoForPlatform) ListTrashedAccounts(context.Context, pagination.PaginationParams, string, string, string) ([]Account, *pagination.PaginationResult, error) {
	return nil, nil, nil
}
...
func (m *mockAccountRepoForPlatform) ListWithFilters(ctx context.Context, params pagination.PaginationParams, platform, accountType, status, search string, groupID int64, privacyMode string, _ bool) ([]Account, *pagination.PaginationResult, error) {
	return nil, nil, nil
}
func (m *mockAccountRepoForPlatform) ListAllWithFilters(ctx context.Context, platform, accountType, status, search string, groupID int64, privacyMode string, _ bool) ([]Account, error) {
	return nil, nil
}
