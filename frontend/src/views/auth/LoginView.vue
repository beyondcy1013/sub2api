...
import { resolveDefaultLandingPath } from '@/router/setupRedirect'
...
async function handleLogin(): Promise<void> {
  ...
  try {
    ...
    const redirectTo = (router.currentRoute.value.query.redirect as string) || resolveDefaultLandingPath(authStore.isAdmin)
