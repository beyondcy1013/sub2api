<template>
  <Teleport to="body">
    <div v-if="show && position">
      ...
      <div
        class="action-menu-content fixed z-[9999] max-h-[calc(100vh-1rem)] w-[7.8rem] overflow-x-hidden overflow-y-auto rounded-xl bg-white shadow-lg ring-1 ring-black/5 dark:bg-dark-800"
