...
function updatePosition() {
  ...
  tooltipStyle.value = {
    top: `${(props.placement === 'bottom' ? rect.bottom : rect.top) + window.scrollY}px`,
      ...
      >
        ...
        <div
          :class="[
            ...
            props.placement === 'top' ? '-bottom-1' : '-top-1',
          ]"
        ></div>
      </div>
    </Teleport>
