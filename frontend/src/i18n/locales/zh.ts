export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      accountCloned: '账号克隆成功',
      failedToClone: '克隆账号失败',
      autoRefresh: '自动刷新',
      ...
      quotaLimitHint: '设置小时/日/周/总使用额度（美元），任一维度达到限额后账号暂停调度。Anthropic API Key 账号还可配置客户端亲和。修改限额不会重置已用额度。',
      quotaLimitToggle: '启用配额限制',
      quotaLimitToggleHint: '开启后，当账号用量达到设定额度时自动暂停调度',
      quotaHourlyLimit: '小时限额',
      quotaHourlyLimitHint: '从首次使用起每 5 小时自动重置。',
      quotaDailyLimit: '日限额',
      ...
      apiKeyPlainVisibleHint: '当前 API Key 已完整显示，直接编辑即可替换。',
      // Upstream type
      upstream: {
        baseUrl: '上游 Base URL',
