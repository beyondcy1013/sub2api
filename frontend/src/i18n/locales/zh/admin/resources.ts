export default {
    scheduledTests: {
      ...
      visualBuilder: '可视化排程',
      builderHelp: '帮助',
      builderHelpBody: '点击排程模式并选择时间，系统会自动生成 Cron 表达式。特殊规则可切换到“自定义”后直接编辑上方表达式。',
      cronFieldOrder: '字段顺序：分钟 小时 日期 月份 星期',
      modeInterval: '按分钟间隔',
      modeHourly: '每小时',
      modeDaily: '每天',
      modeWeekly: '每周',
      ...
      minuteCount: '每 {count} 分钟',
      hour: '小时',
      minute: '分钟',
      weekday: '星期',
      previewInterval: '每 {count} 分钟运行一次',
      previewHourly: '每小时第 {minute} 分运行',
      previewDaily: '每天 {time} 运行',
      previewWeekly: '每周{weekday} {time} 运行',
      previewCustom: '当前为自定义 Cron 表达式',
      weekdays: {
        monday: '一',
        tuesday: '二',
        wednesday: '三',
      ...
      autoRecoverSchedulable: '自动启用调度',
      autoRecoverSchedulableHelp: '测试成功后自动重新启用被暂停调度的账号'
    },
