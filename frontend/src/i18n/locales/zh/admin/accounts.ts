export default {
    accounts: {
      ...
      enhancedImportHint: '兼容 CLIProxyAPI 认证 JSON 与 sub2api 导出 JSON。',
      enhancedImportFileMode: 'JSON 文件',
      enhancedImportTextMode: 'JSON 文本',
      enhancedImportTextLabel: 'JSON 文本',
      enhancedImportTextPlaceholder: '粘贴 JSON 对象或数组',
