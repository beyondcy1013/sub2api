export default {
    accounts: {
      ...
      stickySessions: {
        ...
        source: '来源账号',
        bound: '绑定会话',
        recentBound: '近期活跃 / 全部绑定',
        activeWindow: '活跃时间窗口',
        window1m: '最近 1 分钟',
        window5m: '最近 5 分钟',
        window15m: '最近 15 分钟',
        window60m: '最近 60 分钟',
        noRecent: '所选时间窗口内没有可迁移的活跃会话。',
        recentSessions: '近期活跃会话（匿名尾号）',
        justNow: '刚刚',
        secondsAgo: '{count} 秒前',
        minutesAgo: '{count} 分钟前',
        sourceLoad: '来源负载',
        targetHeadroom: '目标空余槽位',
        count: '迁移数量',
        countHint: '只迁移所选时间窗口内最近活跃的 session_hash，按活跃时间排序，单次最多 100 条。下一次请求会使用目标账号。',
        protected: '已保护 {count} 条 previous_response_id 续链记录，不参与迁移。',
        userLimitWarning: '“Concurrency limit exceeded for user” 由 sub2api 的调用方总并发槽位超时产生，并非上游账号原文。多个粘性会话集中到同一上游账号时，等待账号槽位的请求也会占住调用方槽位，可能在其他账号仍有空余时触发此错误；把部分会话迁入有空余容量的当前账号可缓解该问题。',
        empty: '当前账号所在分组没有可迁移的粘性会话。',
        submit: '迁入当前账号',
        confirm: '确认把最近活跃的 {count} 条粘性会话迁入 {target}？进行中的上游对话不会被中断，但后续请求将使用目标账号。',
        success: '已迁移 {count} 条粘性会话',
        loadFailed: '加载粘性会话分布失败',
        failed: '迁移粘性会话失败'
      },
      recycle: '归档',
      restore: '取消归档',
      ...
      viewDeleted: '查看回收站',
      restoreDeleted: '恢复',
      restoreDeletedSuccess: '账号已恢复为正常状态',
      restoreDeletedFailed: '从回收站恢复账号失败',
      // Recycle bin (soft-deleted accounts)
      trashBin: '回收站',
      trashBinTitle: '账号回收站',
      trashBinEmpty: '回收站为空',
      trashBinHint: '已删除的账号在此归档，可恢复或彻底删除',
      restoreFromTrash: '恢复',
      permanentDelete: '彻底删除',
      permanentDeleteConfirm: "确定要彻底删除账号 '{name}' 吗？此操作不可撤销，所有数据将永久丢失。",
      ...
      dataImportWarning: '导入将创建新账号与代理；启用下方设置时，指定代理和分组会应用到全部导入账号。',
      dataImportFile: '数据文件',
      dataImportRoutingTitle: '导入账号设置',
      dataImportApplyProxySettings: '应用代理设置',
      ...
      dataImportSuccess: '导入成功：已新增 {account_created} 个账号。',
      dataImportCompletedWithErrors: '部分导入完成：已新增 {account_created} 个账号；账号失败 {account_failed}，代理失败 {proxy_failed}',
      enhancedImportTitle: '增强导入',
      enhancedImportHint: '兼容 CLIProxyAPI 认证 JSON、sub2api 导出 JSON 和含多段 JSON 的混杂消息。',
      enhancedImportFileMode: 'JSON 文件',
      enhancedImportTextMode: '混杂消息 / JSON',
      enhancedImportTextLabel: '混杂消息或 JSON 文本',
      enhancedImportTextPlaceholder: '可粘贴“第1张 + JSON + 第2张 + JSON + 使用说明”等完整消息',
      enhancedImportUsageGuideTitle: '使用说明',
      enhancedImportUsageGuide: '可粘贴单个 JSON、JSON 数组或含多个完整 JSON 的聊天、转发、Markdown 文本。每段 JSON 会独立校验后合并导入；JSON 必须完整，不能截断。',
      enhancedImportExtractionSummary: '已提取 {sources} 段 JSON，共 {accounts} 个账号',
      enhancedImportExtractionPending: '尚未识别到完整 JSON',
      ...
      enhancedImportClearButton: '批量清除导入账号',
      enhancedImportClearTitle: '批量清除导入账号',
      enhancedImportClearHint: '解析与增强导入相同的 JSON 文件或混杂消息，并将数据库中匹配的账号移入回收站；代理不会被删除。',
      enhancedImportClearing: '清除中...',
      enhancedImportClearNoAccounts: '当前内容中没有可清除的账号',
      enhancedImportPermanentDelete: '彻底删除',
      enhancedImportPermanentDeleteHint: '额外扫描回收站；所有匹配账号都将被永久删除且无法恢复。',
      enhancedImportClearConfirm: '确定按当前内容匹配并清除账号吗？共解析到 {count} 个账号，匹配到 {matched} 个账号。匹配账号将移入回收站，代理不会被删除。',
      enhancedImportPermanentClearConfirm: '确定按当前内容匹配并彻底删除账号吗？共解析到 {count} 个账号，匹配到 {matched} 个账号。已额外扫描回收站；所有匹配账号都将被彻底删除且无法恢复，代理不会被删除。',
      enhancedImportClearSuccess: '清除完成：{account_deleted_staged} 个账号已移入回收站。',
      enhancedImportPermanentClearSuccess: '彻底删除完成：{account_permanently_deleted} 个账号已永久删除。',
      enhancedImportClearCompletedWithErrors: '部分清除完成：移入回收站 {account_deleted_staged}，彻底删除 {account_permanently_deleted}，未找到 {account_not_found}，匹配歧义 {account_ambiguous}，失败 {account_failed}。',
      enhancedImportClearFailed: '批量清除导入账号失败',
      ...
      upstreamBilling: {
        ...
        hoursAgo: '{count} 小时',
        daysAgo: '{count} 天',
        globalProbeState: '全部账号定时检测：',
        enabled: '打开',
        disabled: '关闭',
        probeFailed: '探测上游倍率失败',
        probeCompleted: '{name} 的上游费率检测已完成',
        probeUnsupported: '{name} 的上游不支持费率声明',
        probeFailedForAccount: '{name} 的上游费率检测失败',
      ...
      schedulingRate: {
        ...
        manualLock: '手工锁定',
        autoOverwrite: '自动覆盖',
        autoOverwriteHint: '上游费率检测成功后，用声明的基础倍率覆盖当前手工倍率。关闭后保留手工倍率。',
        manualEditLocks: '已切换为手工锁定，自动覆盖已取消。',
        unknown: '未知',
        edit: '编辑调度倍率',
        manualHint: '按此倍率参与最低费率调度；0 表示免费。',
        optimal: '最优',
        optimalHint: '当前账号在至少一个调度组中费率最低，且账号可调度、存活检测通过。',
        upstreamHint: '使用当前有效上游倍率 {rate}，高峰倍率会按时间自动变化。',
        upstreamUnknown: '上游倍率未探测或已过期，将作为最低费率调度的最后兜底。',
        conflict: '当前倍率 {manual} 与上游声明倍率 {upstream} 不一致。',
        copyUpstream: '用上游倍率覆盖手工倍率',
        updated: '调度倍率已更新',
      ...
      schedulingRules: {
        ...
        help: '？帮助',
        helpTitle: '调度算法说明',
        helpEligibility: '候选范围：账号必须处于可调度状态，并满足分组、平台、模型、额度和并发限制。',
        helpDefault: '默认调度：优先沿用可移动的粘性会话，再按优先级、负载和最近使用情况选择账号。',
        helpLowestCost: '低价优先：先选择最低调度倍率；并列时优先连接负载更低的账号，负载完全相同时轮转分摊。账号满载或不可用时，先尝试同倍率账号，再回退到下一倍率。',
        helpLiveness: '异常恢复检测：正常启用和手工暂停的账号都不检测；仅重试 error 状态的 Key 类型账号，真实请求成功后恢复账号并重新启用调度。OAuth 等其他类型不参与。',
        strategy: '调度策略',
        default: '默认调度',
        lowestCost: '低价优先',
        liveness: '异常账号恢复检测',
        livenessInterval: '检测周期（分钟）',
        livenessThreshold: '连续失败阈值',
        livenessHint: '仅在低价优先模式重试 error 状态的 Key 类型账号。正常启用和手工暂停账号不会被检测；真实请求成功后自动恢复启动状态并启用调度。',
        runtimeLabel: '循环测试',
        runtimeLoading: '正在读取状态',
        runtimeUnavailable: '状态暂不可用',
        runtimeRunning: '正在检测异常账号恢复',
        runtimeDisabled: '低价优先未启用',
        runtimeWaiting: '暂无待检测账号',
        runtimeStartingSoon: '即将开始检测',
        runtimeCountdown: '距离检测 {duration}',
        runtimeDueCountdown: '等待启动 {duration}',
        runtimeProgress: '距离下次检测的周期进度',
        runtimeNextSeconds: '{seconds} 秒后开始检测',
        runtimeNextMinutes: '{minutes} 分 {seconds} 秒后开始检测',
        runtimeNoResult: '暂无检测结果',
        runtimeLastResult: '{time} · 成功 {succeeded} / 失败 {failed} / 跳过 {skipped}',
        runtimeLastError: '最近检测失败：{error}',
      ...
      testConnection: '测试连接',
      superPriority: '超级优先',
      superPriorityActive: '超级优先模式已激活',
      superPriorityInactive: '超级优先模式未激活',
      superPriorityActivatedAt: '激活时间',
      superPriorityDemotedAt: '降级时间',
      superPriorityNeverActivated: '从未激活',
      superPriorityRuntime: '运行参数',
      superPriorityThreshold: '失败阈值',
      superPriorityThresholdHint: '一分钟内失败达到该次数则自动降级',
      superPriorityInterval: '检测间隔',
      superPriorityTestModel: '测试模型',
      superPriorityTestModelPlaceholder: '留空使用平台默认测试模型',
      superPriorityBaseStrategy: '基础调度策略',
      superPriorityBaseStrategyDefault: '默认优先级与负载',
      superPriorityBaseStrategyLowestCost: '账号费率最低优先',
      superPriorityBaseStrategyHint: '用于各偏好层内选择，超级优先账号不可用时会自然回退。',
      superPrioritySettings: '超级优先设置',
      superPriorityMark: '标记为超级优先',
      superPriorityUnmark: '取消超级优先',
      superPriorityMarked: '已标记为超级优先',
      superPriorityUnmarked: '已取消超级优先',
      failedToToggleSuperPriority: '切换超级优先失败',
      autoTest: '自动测试',
      pin: '置顶',
      unpin: '取消置顶',
      pinSuccess: '账号已置顶',
      ...
      accountDeleted: '账号已移入回收站',
      rateLimitCleared: '速率限制已清除',
      setupToken: 'Setup Token',
      apiKey: 'API Key',
      apiKeyPlainVisibleHint: '账号检查与编辑场景会以明文显示 API Key。',
      deleteConfirm: "确定要将账号 '{name}' 移入回收站吗？账号数据会完整保留并可随时恢复，但不再参与请求调度和各类自动扫描。",
      ...
      status: {
        ...
        runtimeBlocked: '调度熔断',
        runtimeBlockedUntil: '临时调度熔断至 {time}',
        proxyQuarantined: '代理流熔断',
        proxyQuarantinedUntil: '代理流熔断至 {time}',
        modelRuntimeBlocked: '{model} 临时熔断',
        modelRuntimeBlockedUntil: '{model} 临时熔断至 {time}',
      ...
      tempUnschedulable: {
        ...
        multipleErrorTrigger: '在 {minutes} 分钟内累计 {count} 次匹配错误，达到阈值 {threshold}。',
        multipleErrorTriggerNoWindow: '累计 {count} 次匹配错误，达到阈值 {threshold}。',
      ...
      usageWindow: {
        ...
        sort: {
          ...
          fiveHourReset: '5h剩余时间',
          sevenDayUtilization: '7d使用比例',
          sevenDayReset: '7d剩余时间',
          defaultOrder: '恢复列表顺序'
        },
      ...
      bulkActions: {
        ...
        selectGroup: '批量修改群组',
        noGroup: '无群组',
        updatingProxy: '正在修改代理...',
        updatingGroup: '正在修改群组...',
        proxyUpdated: '已更新 {count} 个账号的代理',
        groupUpdated: '已更新 {count} 个账号的群组',
        ...
        delete: '批量删除',
        permanentDelete: '彻底删除',
        permanentlyDeleting: '正在彻底删除...',
        confirmDelete: '确认删除选中的 {count} 个账号吗？此操作不可恢复。',
        deleteSuccess: '已成功删除 {count} 个账号',
        deleteConfirm: '确定批量删除这 {count} 个账号吗？请核对数量后再继续。',
        permanentDeleteConfirm: '确定要彻底删除选中的 {count} 个账号吗？此操作不可撤销，所有数据将永久丢失。',
        permanentDeleteSuccess: '已彻底删除 {count} 个账号',
        permanentDeletePartial: '部分彻底删除完成：成功 {success} 个，失败 {failed} 个',
        enableScheduling: '批量启用调度',
        disableScheduling: '批量停止调度',
        resetStatus: '批量重置状态',
        refreshToken: '批量刷新令牌',
        testAndMark: '批量测试并标记',
        testingAndMarking: '正在测试并标记...',
        testAndMarkSuccess: '已成功测试 {count} 个账号，均未发现异常',
        testAndMarkPartial: '批量测试完成：正常 {success} 个，异常 {failed} 个，其中达到窗口阈值并标记 {marked} 个',
        testAndMarkFailed: '批量测试账号失败',
        probeUpstreamBilling: '探测上游倍率',
        refreshUsage: '批量更新额度',
        refreshingUsage: '正在更新额度...',
        refreshUsageSuccess: '已成功更新 {count} 个账号的额度',
        refreshUsagePartial: '额度更新部分完成：成功 {success} 个，失败 {failed} 个',
        refreshUsageNoEligible: '当前范围内没有支持主动额度查询的账号',
      ...
      testRecoveryTitle: '连接测试成功',
      testRecoveryMessage: '账号“{name}”连接测试成功，但当前未处于正常可调度状态。是否恢复账号状态并启用调度？',
      testFailedTitle: '连接测试失败',
      testFailedMessage: '账号“{name}”连接测试失败。是否将账号标记为失败并停止调度？',
      markAsFailed: '标记为失败',
      markAsFailedSuccess: '账号已标记为失败',
      markAsFailedFailed: '账号未能标记为失败',
      balanceQuery: {
        action: '查询余额',
        title: '查询上游余额',
        scheme: '检测算法',
      ...
      scheduledAction: {
        ...
        account: '目标账号',
        action: '到期操作',
        enableAndRecover: '定时启用并恢复',
        pause: '定时暂停调度',
        hours: '小时',
        minutes: '分钟',
        minimumDelay: '延时必须至少为 1 分钟，分钟数需在 0 到 59 之间。',
        enableSummary: '将在 {hours} 小时 {minutes} 分钟后启用调度并恢复正常状态。',
        pauseSummary: '将在 {hours} 小时 {minutes} 分钟后暂停调度。',
        targetTime: '预计执行时间',
        currentTask: '当前待执行任务',
        lastError: '上次执行失败',
        cancelTask: '取消当前任务',
      ...
      relayFailureBudget: {
        title: '中继失败预算',
        hint: '自定义 OpenAI 中继在窗口期内失败比例未超标时继续保持可用。',
        windowMinutes: '窗口期（分钟）',
        thresholdPercent: '失败阈值（%）',
        minRequests: '最少请求数',
        consecutiveFailures: '连续失败上限',
        cooldownMinutes: '冷却时间（分钟）',
        customRelayRequired: '中继失败预算只能用于自定义 OpenAI Base URL。',
        invalidValues: '中继失败预算参数超出允许范围。'
      },
      ...
      startingTestForAccountWithUpstream: '开始测试账号：{name}（上游：{url}）',
      ...
      pelicanPromptScenario: '提示词方案',
      pelicanPromptScenarioName: '方案名称',
      pelicanPromptScenarioDefault: '默认方案',
      pelicanPromptScenarioNew: '新方案',
      pelicanPromptAdd: '新增方案',
      pelicanPromptDelete: '删除方案',
      pelicanTestHint: '向账号发送绘制鹈鹕骑自行车的独立 HTML 指令，通过判定返回是否为完整 HTML/SVG 动画检测模型是否遭遇风控降智。',
      pelicanTestMode: '模式：鹈鹕测智 / 降智检测',
      pelicanPassed: '测智通过（未降智）',
      pelicanDowngraded: '疑似降智',
      pelicanNormal: '满血',
      pelicanPreviewTab: '动画预览',
      ...
      pelicanModel: '测试大模型',
      pelicanModelPlaceholder: '输入或选择大模型（如 gpt-6-astra）',
      pelicanModelDefault: '账号默认模型',
      pelicanEffort: '思考程度',
      pelicanEffortDefault: '默认 (low)',
      pelicanEffortLow: '低 (low - 默认)',
      pelicanEffortMedium: '中 (medium)',
      pelicanEffortHigh: '高 (high)',
      pelicanEffortXHigh: '极高 (xhigh)',
      pelicanEffortMax: '最大 (max)',
      pelicanMarkDowngraded: '标记降智',
      pelicanMarkNormal: '标记满血',
      pelicanMarkingStatus: '标记中...',
      pelicanManualMark: '手动标记',
      // Stats Modal
      viewStats: '查看统计',
