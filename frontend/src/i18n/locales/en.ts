export default {
  ...
  admin: {
    ...
    accounts: {
      ...
      accountCloned: 'Account cloned successfully',
      ...
      quotaLimitHint: 'Set hourly/daily/weekly/total spending limits (USD). Anthropic API key accounts can also configure client affinity. Changing limits won\'t reset usage.',
      ...
      quotaHourlyLimit: 'Hourly Limit',
      quotaHourlyLimitHint: 'Automatically resets every 5 hours from first usage.',
      ...
      apiKeyPlainVisibleHint: 'The current API Key is shown in full. Edit it directly to replace the key.',
      // Upstream type
      upstream: {
