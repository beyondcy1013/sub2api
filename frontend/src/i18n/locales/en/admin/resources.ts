export default {
    scheduledTests: {
      ...
      visualBuilder: 'Visual schedule',
      builderHelp: 'Help',
      builderHelpBody: 'Choose a schedule mode and time to generate the Cron expression automatically. For special rules, switch to Custom and edit the expression above.',
      cronFieldOrder: 'Field order: minute hour day month weekday',
      modeInterval: 'Minute interval',
      modeHourly: 'Hourly',
      modeDaily: 'Daily',
      modeWeekly: 'Weekly',
      modeCustom: 'Custom',
      intervalMinutes: 'Interval',
      minuteCount: 'Every {count} minutes',
      hour: 'Hour',
      minute: 'Minute',
      weekday: 'Weekday',
      previewInterval: 'Runs every {count} minutes',
      previewHourly: 'Runs at minute {minute} of every hour',
      previewDaily: 'Runs daily at {time}',
      previewWeekly: 'Runs every {weekday} at {time}',
      previewCustom: 'Using a custom Cron expression',
      weekdays: {
        monday: 'Monday',
        tuesday: 'Tuesday',
        wednesday: 'Wednesday',
      ...
      autoRecoverSchedulable: 'Auto Re-enable Scheduling',
      autoRecoverSchedulableHelp: 'Automatically re-enable scheduling for paused accounts on successful test'
    },
