export default {
    accounts: {
      ...
      enhancedImportHint: 'Accepts CLIProxyAPI auth JSON and sub2api export JSON.',
      enhancedImportFileMode: 'JSON Files',
      enhancedImportTextMode: 'JSON Text',
      enhancedImportTextLabel: 'JSON text',
      enhancedImportTextPlaceholder: 'Paste a JSON object or array',
