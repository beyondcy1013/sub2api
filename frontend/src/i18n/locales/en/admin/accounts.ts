export default {
    accounts: {
      ...
      recycle: 'Stash',
      restore: 'Unstash',
      viewRecycled: 'View Stashed',
      viewNormal: 'Normal Accounts',
      viewDeleted: 'View Deleted Staging',
      restoreDeleted: 'Restore',
      restoreDeletedSuccess: 'Account restored to the normal list',
      restoreDeletedFailed: 'Failed to restore deleted-staging account',
      ...
      enhancedImportClearHint: 'Parse the same JSON files or mixed messages as Enhanced Import and move matching database accounts to recoverable deleted staging. Proxies are never deleted.',
      enhancedImportClearing: 'Clearing...',
      enhancedImportClearNoAccounts: 'This content contains no accounts to clear',
      enhancedImportClearConfirm: 'Match and clear the accounts parsed from this content? {count} account(s) were parsed. Matches will move to recoverable deleted staging; proxies will not be deleted.',
      enhancedImportClearSuccess: 'Clear completed: {account_cleared} account(s) moved to deleted staging.',
      enhancedImportClearCompletedWithErrors: 'Clear partially completed: cleared {account_cleared}, not found {account_not_found}, ambiguous {account_ambiguous}, failed {account_failed}.',
      ...
      deleteAccount: 'Move to Deleted Staging',
      ...
      schedulingRules: {
        ...
        helpLiveness: 'Liveness: only Key accounts are probed. One failure marks an account suspect; failures reaching the threshold exclude it, and a later success restores it. OAuth and other account types are excluded.',
        strategy: 'Scheduling strategy',
        default: 'Default scheduling',
        lowestCost: 'Lowest cost first',
        liveness: 'Connection liveness probe',
        livenessInterval: 'Probe interval (minutes)',
        livenessThreshold: 'Consecutive failure threshold',
        livenessIncludeUnschedulable: 'Include paused accounts',
        livenessIncludeUnschedulableHint: 'When enabled, manually paused Key accounts also participate in connection liveness checks. Off by default.',
        livenessHint: 'Runs in lowest-cost mode for Key accounts only. OAuth and other account types are excluded. One failure is suspect; the threshold excludes the account, and a later success restores it automatically.',
        runtimeLabel: 'Loop test',
        runtimeLoading: 'Loading status',
        runtimeUnavailable: 'Status unavailable',
        runtimeRunning: 'Checking connection liveness',
      ...
      deleteConfirm: "Move '{name}' to deleted staging? All account data remains available and can be restored, but the account will no longer participate in request routing or automated scans.",
