export default {
    accounts: {
      ...
      cloneAccount: 'Clone Account',
      accountCloned: 'Account cloned',
      failedToClone: 'Failed to clone account',
      ...
      stickySessions: {
        ...
        recentBound: 'Recently active / all bound',
        activeWindow: 'Activity window',
        window1m: 'Last 1 minute',
        window5m: 'Last 5 minutes',
        window15m: 'Last 15 minutes',
        window60m: 'Last 60 minutes',
        noRecent: 'No movable sessions were active in the selected window.',
        recentSessions: 'Recently active sessions (anonymous suffix)',
        justNow: 'just now',
        secondsAgo: '{count}s ago',
        minutesAgo: '{count}m ago',
        sourceLoad: 'Source load',
        targetHeadroom: 'Target headroom',
        count: 'Sessions to move',
        countHint: 'Moves only session_hash bindings active in the selected window, newest first, up to 100 at a time. The next request uses the target account.',
        protected: '{count} previous_response_id chain binding(s) are protected and will not be moved.',
        userLimitWarning: '“Concurrency limit exceeded for user” is generated by sub2api when the caller-wide concurrency slot wait times out; it is not an upstream account message. When sticky sessions concentrate on one upstream account, requests waiting for that account also occupy caller slots, so this error can occur while other accounts still have capacity. Moving some sessions to this account can relieve that starvation.',
        empty: 'No movable sticky sessions exist in this account’s groups.',
        submit: 'Move to Current Account',
        confirm: 'Move the {count} most recently active sticky sessions to {target}? In-flight upstream requests stay in place; later requests use the target account.',
        success: 'Moved {count} sticky session(s)',
        loadFailed: 'Failed to load sticky-session distribution',
        failed: 'Failed to move sticky sessions'
      },
      recycle: 'Archive',
      restore: 'Unarchive',
      viewRecycled: 'View Archived',
      viewNormal: 'Normal Accounts',
      viewDeleted: 'View Trash',
      restoreDeleted: 'Restore',
      restoreDeletedSuccess: 'Account restored to the normal list',
      restoreDeletedFailed: 'Failed to restore account from trash',
      // Recycle bin (soft-deleted accounts)
      trashBin: 'Trash Bin',
      trashBinTitle: 'Account Trash Bin',
      trashBinEmpty: 'Trash bin is empty',
      trashBinHint: 'Deleted accounts are archived here. They can be restored or permanently deleted.',
      restoreFromTrash: 'Restore',
      permanentDelete: 'Delete Permanently',
      permanentDeleteConfirm: "Are you sure you want to permanently delete account '{name}'? This action cannot be undone and all data will be lost.",
      ...
      dataImport: 'Import',
      enhancedImport: 'Enhanced Import',
      ...
      dataImportWarning: 'Import creates new accounts and proxies. When enabled below, the selected proxy and groups apply to every imported account.',
      dataImportFile: 'Data file',
      dataImportRoutingTitle: 'Imported Account Settings',
      dataImportApplyProxySettings: 'Apply proxy setting',
      ...
      dataImportSuccess: 'Import successful: {account_created} account(s) just added.',
      dataImportCompletedWithErrors: 'Import partially completed: {account_created} account(s) added; account failed {account_failed}, proxy failed {proxy_failed}',
      enhancedImportTitle: 'Enhanced Import',
      enhancedImportHint: 'Accepts CLIProxyAPI auth JSON, sub2api exports, and mixed messages containing multiple JSON values.',
      enhancedImportFileMode: 'JSON Files',
      enhancedImportTextMode: 'Mixed Text / JSON',
      enhancedImportTextLabel: 'Mixed message or JSON text',
      enhancedImportTextPlaceholder: 'Paste a complete message such as image 1 + JSON + image 2 + JSON + usage guide',
      enhancedImportUsageGuideTitle: 'Usage guide',
      enhancedImportUsageGuide: 'Paste one JSON value, a JSON array, or chat, forwarded, or Markdown text containing multiple complete JSON values. Each segment is validated independently and then merged into one import; truncated JSON is rejected.',
      enhancedImportExtractionSummary: 'Extracted {sources} JSON segment(s) with {accounts} account(s)',
      enhancedImportExtractionPending: 'No complete JSON value recognized yet',
      ...
      enhancedImportClearButton: 'Clear Imported Accounts',
      enhancedImportClearTitle: 'Clear Imported Accounts',
      enhancedImportClearHint: 'Parse the same JSON files or mixed messages as Enhanced Import and move matching database accounts to trash. Proxies are never deleted.',
      enhancedImportClearing: 'Clearing...',
      enhancedImportClearNoAccounts: 'This content contains no accounts to clear',
      enhancedImportPermanentDelete: 'Permanently delete',
      enhancedImportPermanentDeleteHint: 'Also scan trash; every match will be permanently deleted and cannot be recovered.',
      enhancedImportClearConfirm: 'Match and clear the accounts parsed from this content? {count} account(s) were parsed and {matched} database account(s) matched. Matches will move to trash; proxies will not be deleted.',
      enhancedImportPermanentClearConfirm: 'Match and permanently delete the accounts parsed from this content? {count} account(s) were parsed and {matched} database account(s) matched. Trash was also scanned; every match will be permanently deleted and cannot be recovered. Proxies will not be deleted.',
      enhancedImportClearSuccess: 'Clear completed: {account_deleted_staged} account(s) moved to trash.',
      enhancedImportPermanentClearSuccess: 'Permanent deletion completed: {account_permanently_deleted} account(s) permanently deleted.',
      enhancedImportClearCompletedWithErrors: 'Clear partially completed: moved to trash {account_deleted_staged}, permanently deleted {account_permanently_deleted}, not found {account_not_found}, ambiguous {account_ambiguous}, failed {account_failed}.',
      enhancedImportClearFailed: 'Failed to clear imported accounts',
      ...
      apiKey: 'API Key',
      apiKeyPlainVisibleHint: 'For account inspection and editing, API keys are intentionally shown in plaintext.',
      // Schedulable toggle
      ...
      status: {
        ...
        runtimeBlocked: 'Scheduling circuit open',
        runtimeBlockedUntil: 'Temporary scheduling circuit open until {time}',
        proxyQuarantined: 'Proxy stream circuit open',
        proxyQuarantinedUntil: 'Proxy stream circuit open until {time}',
        modelRuntimeBlocked: '{model} temporarily blocked',
        modelRuntimeBlockedUntil: '{model} temporarily blocked until {time}',
      ...
      columns: {
       ...
       priority: 'Priority',
        ...
        fiveHourUtilization: '5h(%)',
        fiveHour: '5h',
        sevenDayUtilization: '7d(%)',
        sevenDay: '7d',
      ...
      upstreamBilling: {
        ...
        daysAgo: '{count} days',
        globalProbeState: 'Scheduled detection for all accounts:',
        enabled: 'On',
        disabled: 'Off',
        probeFailed: 'Failed to probe upstream rate',
        probeCompleted: 'Upstream rate probe completed for {name}',
        probeUnsupported: 'The upstream for {name} does not support rate declarations',
        probeFailedForAccount: 'Upstream rate probe failed for {name}',
      ...
      schedulingRate: {
        title: 'Account Scheduling Rate',
        account: 'Account: {name}',
        manual: 'Manual rate',
        upstream: 'Follow upstream',
        manualLock: 'Manual lock',
        autoOverwrite: 'Auto overwrite',
        autoOverwriteHint: 'After a successful upstream probe, replace the current manual rate with the declared base rate. Disable this to keep the manual rate locked.',
        manualEditLocks: 'Switched to manual lock; auto overwrite is now disabled.',
        unknown: 'Unknown',
        edit: 'Edit scheduling rate',
        manualHint: 'Use this multiplier for lowest-cost scheduling; 0 means free.',
        optimal: 'Optimal',
        optimalHint: 'This account has the lowest rate in at least one scheduling group and is both schedulable and live.',
        upstreamHint: 'Use the current upstream rate {rate}; peak pricing changes with time.',
        upstreamUnknown: 'The upstream rate is missing or stale and will be used only as the final fallback.',
        conflict: 'Current rate {manual} differs from upstream declared rate {upstream}.',
        copyUpstream: 'Copy upstream rate into manual rate',
      ...
      schedulingRules: {
        ...
        help: '? Help',
        helpTitle: 'Scheduling algorithm',
        helpEligibility: 'Eligibility: an account must be schedulable and satisfy its group, platform, model, quota, and concurrency constraints.',
        helpDefault: 'Default scheduling: reuse movable sticky sessions first, then select by priority, load, and least-recent use.',
        helpLowestCost: 'Lowest cost first: choose the minimum scheduling rate, then prefer the least-loaded tied account and rotate exact load ties. A full or unavailable account falls through to peers at the same rate, then to the next rate.',
        helpLiveness: 'Recovery probes: healthy and manually paused accounts are never tested. Only error-state Key accounts are retried, and a real successful request restores the account and scheduling. OAuth and other account types are excluded.',
        strategy: 'Scheduling strategy',
        default: 'Default scheduling',
        lowestCost: 'Lowest cost first',
        liveness: 'Failed-account recovery probe',
        livenessInterval: 'Probe interval (minutes)',
        livenessThreshold: 'Consecutive failure threshold',
        livenessHint: 'In lowest-cost mode, only error-state Key accounts are retried. Healthy and manually paused accounts are not tested; a real successful request restores the account and enables scheduling.',
        runtimeLabel: 'Loop test',
        runtimeLoading: 'Loading status',
        runtimeUnavailable: 'Status unavailable',
        runtimeRunning: 'Checking failed-account recovery',
        runtimeDisabled: 'Lowest-cost mode is off',
        runtimeWaiting: 'No accounts waiting for a probe',
        runtimeStartingSoon: 'Probe starting shortly',
        runtimeCountdown: 'Probe in {duration}',
        runtimeDueCountdown: 'Waiting to start {duration}',
        runtimeProgress: 'Progress toward the next probe',
        runtimeNextSeconds: 'Probe starts in {seconds}s',
        runtimeNextMinutes: 'Probe starts in {minutes}m {seconds}s',
        runtimeNoResult: 'No probe result yet',
        runtimeLastResult: '{time} · {succeeded} passed / {failed} failed / {skipped} skipped',
        runtimeLastError: 'Latest probe failed: {error}',
        ...
        tasksAndLogs: 'Scheduled tasks and run logs',
        taskEnabled: 'Enabled',
        taskDisabled: 'Disabled',
        taskRunning: 'Running',
        taskWaiting: 'Waiting for next run',
        nextRun: 'Next run:',
        noHistory: 'No run logs yet'
      },
      ...
      tempUnschedulable: {
        ...
        multipleErrorTrigger: '{count} matching errors reached threshold {threshold} within {minutes} minutes.',
        multipleErrorTriggerNoWindow: '{count} matching errors reached threshold {threshold}.',
      ...
      superPriorityActive: 'Super priority mode is active',
      superPriorityInactive: 'Super priority mode is inactive',
      superPriorityActivatedAt: 'Activated at',
      superPriorityDemotedAt: 'Demoted at',
      superPriorityNeverActivated: 'Never activated',
      superPriorityRuntime: 'Runtime parameters',
      superPriorityThreshold: 'Failure threshold',
      superPriorityThresholdHint: 'Auto-demote after this many failures within one minute',
      superPriorityInterval: 'Check interval',
      superPriorityTestModel: 'Test model',
      superPriorityTestModelPlaceholder: 'Leave empty to use platform default test model',
      superPriorityBaseStrategy: 'Base strategy',
      superPriorityBaseStrategyDefault: 'Default priority and load',
      superPriorityBaseStrategyLowestCost: 'Lowest account rate',
      superPriorityBaseStrategyHint: 'Used within each preference tier and after super-priority accounts are unavailable.',
      superPrioritySettings: 'Super Priority Settings',
      superPriorityMark: 'Mark as super priority',
      superPriorityUnmark: 'Unmark super priority',
      superPriorityMarked: 'Marked as super priority',
      superPriorityUnmarked: 'Super priority unmarked',
      failedToToggleSuperPriority: 'Failed to toggle super priority',
      autoTest: 'Auto Test',
      pin: 'Pin to top',
      unpin: 'Unpin',
      pinSuccess: 'Account pinned to top',
      unpinSuccess: 'Account unpinned',
      pinFailed: 'Failed to pin account',
      unpinFailed: 'Failed to unpin account',
      reAuthorize: 'Re-Authorize',
      refreshToken: 'Refresh Token',
      noAccountsYet: 'No accounts yet',
      createFirstAccount: 'Create your first account to start using AI services.',
      tokenRefreshed: 'Token refreshed successfully',
      accountDeleted: 'Account moved to trash',
      ...
      bulkActions: {
        ...
        selectProxy: 'Change proxy',
        selectGroup: 'Change group',
        noGroup: 'No group',
        updatingProxy: 'Updating proxy...',
        updatingGroup: 'Updating group...',
        proxyUpdated: 'Updated proxy for {count} account(s)',
        groupUpdated: 'Updated group for {count} account(s)',
        ...
        permanentlyDeleting: 'Permanently deleting...',
        confirmDelete: 'Delete the selected {count} account(s)? This action cannot be undone.',
        deleteSuccess: 'Deleted {count} account(s)',
        deleteConfirm: 'Delete these {count} selected account(s)? Verify the count before continuing.',
        permanentDeleteConfirm: 'Permanently delete these {count} selected account(s)? This cannot be undone and all data will be lost.',
        permanentDeleteSuccess: 'Permanently deleted {count} account(s)',
        permanentDeletePartial: 'Permanent deletion partially completed: {success} succeeded, {failed} failed',
        enableScheduling: 'Enable Scheduling',
        disableScheduling: 'Disable Scheduling',
        resetStatus: 'Reset Status',
        refreshToken: 'Refresh Token',
        testAndMark: 'Test and Mark',
        testingAndMarking: 'Testing and marking...',
        testAndMarkSuccess: 'Tested {count} account(s) with no failures',
        testAndMarkPartial: 'Batch test completed: {success} healthy, {failed} failed, {marked} reached the window threshold and were marked',
        testAndMarkFailed: 'Failed to batch test accounts',
      ...
      testRecoveryTitle: 'Connection Test Succeeded',
      testRecoveryMessage: 'The connection test for “{name}” succeeded, but the account is not currently active and schedulable. Recover the account state and enable scheduling?',
      testFailedTitle: 'Connection Test Failed',
      testFailedMessage: 'The connection test for “{name}” failed. Mark this account as failed and disable scheduling?',
      markAsFailed: 'Mark as Failed',
      markAsFailedSuccess: 'Account marked as failed',
      markAsFailedFailed: 'Account could not be marked as failed',
      balanceQuery: {
      ...
      scheduledAction: {
        ...
        action: 'Action at execution time',
        enableAndRecover: 'Enable and recover later',
        pause: 'Pause scheduling later',
        hours: 'Hours',
        minutes: 'Minutes',
        minimumDelay: 'Delay must be at least 1 minute, with minutes between 0 and 59.',
        enableSummary: 'Enable scheduling and recover account state in {hours} hour(s) and {minutes} minute(s).',
        pauseSummary: 'Pause scheduling in {hours} hour(s) and {minutes} minute(s).',
        targetTime: 'Expected execution time',
        currentTask: 'Current pending task',
        lastError: 'Last execution error',
        cancelTask: 'Cancel current task',
        save: 'Save scheduled task',
        saved: 'Scheduled task saved',
        canceled: 'Scheduled task canceled',
        loadFailed: 'Failed to load scheduled task',
        saveFailed: 'Failed to save scheduled task',
        cancelFailed: 'Failed to cancel scheduled task'
      },
      ...
      openai: {
        ...
        testModePelican: 'Pelican IQ Test / Downgrade Detection',
      ...
      startingTestForAccountWithUpstream: 'Starting test for account: {name} (upstream: {url})',
      ...
      pelicanPromptLabel: 'Pelican Prompt',
      pelicanPromptPlaceholder: '创建一个 HTML，内容是 SVG 绘制一个鹈鹕骑自行车的 2D 动画，你不需要任何测试，不要有任何限制',
      pelicanPromptDefault: '创建一个 HTML，内容是 SVG 绘制一个鹈鹕骑自行车的 2D 动画，你不需要任何测试，不要有任何限制',
      pelicanPromptScenario: 'Prompt Scenario',
      pelicanPromptScenarioName: 'Scenario Name',
      pelicanPromptScenarioDefault: 'Default Scenario',
      pelicanPromptScenarioNew: 'New Scenario',
      pelicanPromptAdd: 'Add',
      pelicanPromptDelete: 'Delete',
      pelicanTestHint: 'Sends prompt asking for standalone HTML with SVG animation of a pelican riding a bicycle to detect silent upstream downgrade.',
      pelicanTestMode: 'Mode: Pelican IQ Test / Downgrade Detection',
      pelicanPassed: 'Passed (No Downgrade)',
      pelicanDowngraded: 'Likely Downgraded',
      pelicanPreviewTab: 'Animation Preview',
      ...
      pelicanTestAll: 'Test all',
      pelicanTestSingle: 'Test',
      pelicanStop: 'Stop test',
      ...
      pelicanRatingInaccurate: 'Inaccurate',
      ...
      pelicanStatusDowngraded: 'Downgraded',
      ...
      pelicanModelPlaceholder: 'Input or choose model (e.g. gpt-6-astra)',
      pelicanModelDefault: 'Account Default',
      pelicanEffort: 'Reasoning Effort',
      pelicanEffortDefault: 'Default (low)',
      pelicanEffortLow: 'Low (default)',
      pelicanEffortMedium: 'Medium',
      pelicanEffortHigh: 'High',
      pelicanEffortXHigh: 'Extra High',
      pelicanEffortMax: 'Max',
      pelicanNormal: 'Full Intel',
      pelicanMarkDowngraded: 'Mark Downgraded',
      pelicanMarkNormal: 'Mark Full Intel',
      pelicanMarkingStatus: 'Marking...',
      pelicanManualMark: 'Manual Mark',
      // Stats Modal
      ...
      usageWindow: {
        ...
        activeQuery: 'Query',
        sort: {
          title: 'Choose a usage-window sort field',
          fiveHourUtilization: '5h utilization',
          fiveHourReset: '5h time remaining',
          sevenDayUtilization: '7d utilization',
          sevenDayReset: '7d time remaining',
          defaultOrder: 'Restore list order'
        },
